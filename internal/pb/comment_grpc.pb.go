...
type CommentServiceClient interface {
	...
	GetComments(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*CommentsResponse, error)
...
func (c *commentServiceClient) GetComments(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*CommentsResponse, error) {
...
type CommentServiceServer interface {
	...
	GetComments(context.Context, *empty.Empty) (*CommentsResponse, error)
...
func (UnimplementedCommentServiceServer) GetComments(context.Context, *empty.Empty) (*CommentsResponse, error) {
...
func _CommentService_GetComments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentServiceServer).GetComments(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
