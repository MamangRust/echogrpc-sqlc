...
INSERT INTO posts (title,slug,img,body,category_id,user_id,user_name) VALUES ($1,$2,$3,$4,$5,$6,$7) RETURNING id, title, slug, img, body, category_id, user_id, user_name, created_at, updated_at
`
...
func (q *Queries) GetPostRelation(ctx context.Context, id int32) (*GetPostRelationRow, error) {
	row := q.db.QueryRowContext(ctx, getPostRelation, id)
...
SELECT id, title, slug, img, body, category_id, user_id, user_name, created_at, updated_at FROM posts ORDER BY id DESC
`
...
UPDATE posts SET title=$2,slug=$3,img=$4,body=$5,category_id=$6,user_id=$7,user_name=$8 WHERE id=$1 RETURNING id, title, slug, img, body, category_id, user_id, user_name, created_at, updated_at
`
